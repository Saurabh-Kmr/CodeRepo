...
export default class Fep_reScheduleAppointmentScreen extends LightningModal {
    @api content;
    showDate = true;
    inputDate;
    timeSlotToCoachData;
    ...
    connectedCallback(){
        ...
        this.modelHeading = this.content.isCoachBios ? 'Schedule Appointment': 'Reschedule Appointment';
        this.thankyouMessage = this.content.isCoachBios ? 'scheduled': 'rescheduled';
        this.handleLoad();
      ...
      handleTZChange(event){
        ...
        this.coachSelectedId =  this.content.coachId;
        this.serviceAppointmentId = this.content.appointmentId;
    ...
    handleDateChange(event){
        this.isCoachBios = this.content.isCoachBios;
        this.coachSelectedId =  this.content.coachId;
        this.coachSelected = this.content?.coachName ? this.content.coachName : null;
        this.serviceAppointmentId = this.content.appointmentId;
        ...
        getAllAvailableTimeSlotsForCoach({selectedTime:this.inputDate,userId:userId,serviceAppointmentId:this.serviceAppointmentId,coachId:this.coachSelectedId,timeZone:this.selectedTimeZoneValue}).then((data,error)=>{
                ...
                if(data){
                     ...
                     if(coachTimeData != null){
                        ...
                        this.slotDuration = JSON.parse(coachTimeData.slotduration);
